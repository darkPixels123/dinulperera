        ...
        <Grid xs={12} lg={6} item container>
          ...
          <Grid item xs={12} className={styles.myDesc}>
            ...
            <p>
              ...
              needs. With extensive experience across diverse industries such as
              e-commerce, education, and healthcare, I have successfully
              completed a wide range of projects, from responsive web designs to
              comprehensive full-stack applications
            </p>
            <p>
              My commitment to continuous professional development ensures that
              I stay at the forefront of industry advancements, allowing me to
              consistently deliver innovative solutions that not only meet but
              exceed client expectations. This dedication to excellence is
              reflected in my proven track record of delivering outstanding
              results, underscored by a deep technical acumen and a relentless
